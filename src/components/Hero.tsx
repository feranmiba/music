  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <p className="text-xl md:text-2xl text-purple-200 mb-8 animate-slide-up" style={{animationDelay: '0.2s', animationFillMode: 'both'}}>
          Singer • Songwriter • Producer
        </p>
        <p className="text-lg text-gray-300 mb-12 max-w-2xl mx-auto animate-slide-up" style={{animationDelay: '0.4s', animationFillMode: 'both'}}>
          Creating music that touches souls and moves hearts. Experience the journey through sound and emotion.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 animate-scale-in" style={{animationDelay: '0.6s', animationFillMode: 'both'}}>
          ...
          <Button variant="outline" className="border-white text-black hover:bg-white hover:text-black px-8 py-3 text-lg transition-all duration-300 hover:scale-105 hover:shadow-lg">
